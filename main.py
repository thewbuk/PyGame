...
icon=pygame.image.load('images/teamwork1.png')
pygame.display.set_icon(icon)

#Player
playerimg = pygame.image.load('images/girl.png')
playerX=370
playerY=500
playerXchange=0
playerYchange=0
...
#Enemy
enemyimg = pygame.image.load('images/girl2.png')
...
#Background
background=pygame.image.load('images/pizza-3.jpg')

#Pizza Bullet
bulletimg=pygame.image.load('images/pizzaslice.png')
bulletX=370
bulletY=500
bulletXchange=0
bulletychange=10
...
#Broccoli Bullet
broccoliimg=pygame.image.load('images/broccoli.png')
...
back_oryg=pygame.image.load('images/pizza-2.jpg')
